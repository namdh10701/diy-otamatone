...
public class LevelEditor : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        loadedLevelDefinition.SongDefinition = (SongDefinition)EditorGUILayout.ObjectField("Song Definition", loadedLevelDefinition.SongDefinition, typeof(LevelDefinition), false);
    ...
    private void LoadLevel(LevelDefinition levelDefinition)
    {
        ...
        ClearNotes();
        loadedLevelDefinition.SongDefinition = levelDefinition.SongDefinition;
