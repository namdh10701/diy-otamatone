...
namespace Monetization.Ads
{
    ...
    public class IronSourceAds : MonoBehaviour
    {
        ...
        private void Banner_onLoaded(IronSourceAdInfo obj)
        {
            ...
            FirebaseAnalytics.LogEvent("ad_banner_show");
        ...
        public void LoadInter()
        {
            if (!Initilized || !AdsController.Instance.HasInternet || _isRequestingInter)
                return;
            FirebaseAnalytics.LogEvent(Constant.AD_REQUEST);
            FirebaseAnalytics.LogEvent("ad_interstitial_load");
        ...
        private void Reward_onOpen(IronSourceAdInfo info)
        {
            ...
            FirebaseAnalytics.LogEvent("ad_video_show");
            _isRewarded = false;
        ...
        {
            FirebaseAnalytics.LogEvent("ad_video_reward");
        ...
        private IEnumerator CheckRewarded()
        {
            ...
            if (!_isRewarded)
            {
                ...
                FirebaseAnalytics.LogEvent(Constant.REWARD_FAILED);
