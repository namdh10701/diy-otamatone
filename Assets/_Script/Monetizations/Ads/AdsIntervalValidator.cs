...
namespace Monetization.Ads
{
    public static class AdsIntervalValidator
    {
        ...
        public static double INTERVAL_OPEN_INTER = 3;
        public static double INTERVAL_OPEN_OPEN = 3;
        public static double INTERVAL_REWARD_INTER = 5;
            ...
            switch (type)
            {
                ...
                case AdType.OPEN:
                    ...
                    if (timeShowInterAds_OpenAds.TotalSeconds > 0
                        && timeShowInterAds_OpenAds.TotalSeconds < INTERVAL_OPEN_INTER)
                    {
                        ret = false;
                    }
                    ...
                    if (timeShowOpenAds_OpenAds.TotalSeconds > 0
                        && timeShowOpenAds_OpenAds.TotalSeconds < INTERVAL_OPEN_OPEN)
                    {
                        ret = false;
                    }
                    break;
